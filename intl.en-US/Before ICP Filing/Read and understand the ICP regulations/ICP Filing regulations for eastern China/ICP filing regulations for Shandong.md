# ICP filing regulations for Shandong {#concept_m3p_1gm_zdb .concept}
...
-   The name of the domain name holder must be consistent with that of the ICP filing entity or the legal representative.
...
-   If three or more domain names with different prefixes are to be filed under a single website, state "The domain names direct to the same website" in the remarks section.
-   The domain name must be valid for more than three months.
