# ICP filing regulations for Ningxia {#concept_wsw_hgm_zdb .concept}

## Enterprise users {#section_prg_sg5_1fb .section}

 **Important rules** 

-   Enterprises must use copies of their business licenses for ICP filing.
...
-   Individuals whose ID cards are not from Ningxia cannot apply for an ICP filing.
-   From 00:00 on January 1, 2018, the relevant authorities start performing domain name verification for all submitted website ICP filing applications.
