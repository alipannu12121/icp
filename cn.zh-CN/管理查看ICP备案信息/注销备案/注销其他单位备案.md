...
**说明：** 湖南省管局会在每周五统一处理本周内提交的注销申请，其他省市管局处理时间请在 *注销备案申请表* 中查看 。
...
4.  按照注销申请表中的要求，将申请表和所需证件一起递交至通信管理局。 
    ...
    **说明：** 湖南地区用户请访问[注销备案申请](http://202.103.111.10/zwdtportal/wzzxManage/toSitesLogoutPage.jsi)网站，在线完成信息填写并按照页面指示上传申请表等附件，完成后线上提交至通信管理局。
...
-   登录[工信部备案管理系统](http://www.beian.miit.gov.cn)，单击**公共查询**，可查询备案信息。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/14203/156715944611194_zh-CN.png)
